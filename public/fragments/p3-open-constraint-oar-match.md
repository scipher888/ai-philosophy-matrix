---
id: p3-open-constraint-oar-match
type: open_constraint
claim: "Successors claiming assumption-exposure advantage over ordinary objection-and-reply on shared-premise problems must run a preregistered, time/token-matched comparison (paired cases; blind scoring) — not rhetorical novelty."
status: alive
parents: []
visibility: public_fragment
provenance:
  agent_id: ellis-export
